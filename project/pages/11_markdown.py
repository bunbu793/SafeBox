...
.trophy::before{
    ...
    background:
        radial-gradient(
            circle,
            rgba(255,240,170,.45) 0%,
            rgba(255,215,0,.20) 45%,
            rgba(255,215,0,0) 80%
        );
...
@keyframes particle1{
    ...
    50%{opacity:1;}
    100%{transform:translate(-40px,-70px) scale(1.6);opacity:0;}
}

@keyframes particle2{
    0%{transform:translate(0,0);}
    100%{transform:translate(50px,-90px);opacity:0;}
}
...
@keyframes particle4{
    0%{transform:translate(0,0);}
    100%{transform:translate(45px,80px);opacity:0;}
}
...
@keyframes auraPulse{
    0%{transform:translate(-50%,-50%) scale(.75);opacity:.35;}
    50%{transform:translate(-50%,-50%) scale(1.05);opacity:.8;}
    100%{transform:translate(-50%,-50%) scale(.75);opacity:.35;}
}

@keyframes beam{
    0%{opacity:.2;transform:translateX(-50%) scaleY(.6);}
    50%{opacity:1;transform:translateX(-50%) scaleY(1.15);}
    100%{opacity:.2;transform:translateX(-50%) scaleY(.6);}
}
